...
export default function Footer() {
  return <footer className="site-footer">
    <div className="footer-grid">
      <div><Link href="/" className="site-logo"><span className="brand-mark"><img src="https://ik.imagekit.io/e8vtmc5nh/Picsart_26-07-30_18-01-53-939.png" alt="" /></span> Selltronics</Link><p>India&apos;s simple, secure way to give technology a second life.</p></div>
