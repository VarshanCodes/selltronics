...
type Product = { id: string; brand?: string; category?: string; deviceName?: string; storage?: string; specs?: string; price?: number; originalPrice?: number; deviceImageCode?: string | null; createdAt?: any; status?: string; };
