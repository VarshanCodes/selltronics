          ...
          <div className="animate-[fade-in-up_0.3s_ease-out]">
            ...
            <form onSubmit={handleFinalSubmit} className="space-y-6 mt-6">
              <div>
                ...
                <input type="text" required value={modelName} onChange={(e) => setModelName(e.target.value)} placeholder="e.g. iPad Air 5th Gen (64GB)" className="w-full h-12 min-h-[48px] px-4 py-3.5 rounded-xl border-[1.5px] border-[#E3D9F9] focus:border-[#7C3AED] focus:ring-2 focus:ring-purple-600 focus:outline-none text-[16px] sm:text-base box-border" />
              </div>
