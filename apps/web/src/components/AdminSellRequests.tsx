...
export default function AdminSellRequests({ requests: propRequests }: { requests?: SellRequest[] }) {
  ...
  const handleSendWhatsApp = (request: SellRequest, type: "success" | "fail") => {
    ...
    const message = type === "success"
      ? `You successfully selled your device ${request.brand} ${request.deviceName || ""} with Selltronics.`
      : "Not selled based on the customer.";
