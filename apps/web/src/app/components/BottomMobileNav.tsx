...
export default function BottomMobileNav() {
  ...
  const items = [
    ...
    },
    {
      ...
      href: '/repair',
      icon: (active: boolean) => (
        <svg viewBox="0 0 24 24" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={active ? '0' : '1.8'} width="22" height="22" strokeLinecap="round" strokeLinejoin="round">
